...
var constants = {
    ...
    toolArray: ['background~Background~fa fa-photo~backgroundDiv~Background'
                    ...
                    ,'element~Show Elements Panel~fa fa-flask~elementDiv~Items'
    ...
    backgroundArray: ['cgBackground~Change Background~fa fa-photo~cgBackgroundDiv~ChooseBG'
                    ...
                    /* ,'openBlurryBackground~View Blurred Background in New Tab~fa fa-external-link~openBlurryBackgroundDiv'*/
                     ,'backToTools~Back~fa fa-arrow-left~backToToolsDiv~GoBack'
                     ,'clearBackground~Clear Background~fa fa-trash~clearBackgroundDiv~ClearBG'],
